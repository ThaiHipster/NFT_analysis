...
mid_mints <- read.csv("mid_mints_df.csv", header = T)
mid_value <- read.csv("mid_value_df.csv", header = T)
mid_owner <- read.csv("mid_owner_df.csv", header = T)
mid_trans <- read.csv("mid_trans_df.csv", header = T) 
...
write.csv(combo_df_reduced,"combo_df.csv", row.names = F)
